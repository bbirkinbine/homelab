...
# stock-Windows behaviors that are noise in a homelab base image.
#
# Mirrors the spirit of Ubuntu's 15-ubuntu-cleanup.sh — remove the parts of
# the OS that "phone home" or burn disk on the wrong things.
...
# Roles that want auto-update re-enable.
# ----------------------------------------------------------------------
