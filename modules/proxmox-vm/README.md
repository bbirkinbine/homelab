...
base = per-node VMIDs `9100`/`9101`/`9102`/`9103`, Windows 11 base = `9200`/`9201`/`9202` — see [ADR-0006](../../docs/decisions/0006-packer-templates-per-node.md)) into a per-role VM
