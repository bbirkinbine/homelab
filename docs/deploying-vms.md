...
| --- | --- | --- | --- |
| 1. **Packer** | Universal hardening baked into a template | [`packer/ubuntu-24-04-base/`](../packer/ubuntu-24-04-base/) → VM 9100. [`packer/windows-11-base/`](../packer/windows-11-base/) → VM 9101. | Rarely (OS or universal-base changes) |
